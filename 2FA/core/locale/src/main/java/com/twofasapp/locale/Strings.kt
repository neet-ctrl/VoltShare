...
class Strings(c: Context) {
    ...
    val backupSyncDetailsTitle = c.getString(R.string.backup_sync_details_title)
    val backupSyncDetailsNever = c.getString(R.string.backup_sync_details_never)
    val backupSyncDetailsLastSuccessful = c.getString(R.string.backup_sync_details_last_successful)
    val backupSyncDetailsRelative = c.getString(R.string.backup_sync_details_relative)
    val backupSyncDetailsCountsUnavailable = c.getString(R.string.backup_sync_details_counts_unavailable)
    val backupSyncDetailsTokens = c.getString(R.string.backup_sync_details_tokens)
    val backupSyncDetailsSecretEntries = c.getString(R.string.backup_sync_details_secret_entries)
    val backupSyncDetailsSecretTrash = c.getString(R.string.backup_sync_details_secret_trash)
