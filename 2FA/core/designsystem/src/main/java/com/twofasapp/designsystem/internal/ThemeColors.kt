...
data class ThemeColors(
    ...
    val glassSurface: Color = Color.Unspecified,
    val glassSurfaceStrong: Color = Color.Unspecified,
    val glassOutline: Color = Color.Unspecified,
    val accentBlue: Color = Color.Unspecified,
