            ...
            backupRepository.observeCloudBackupStatus().collect { cloudBackupStatus ->
                uiState.update {
                    it.copy(
                        ...
                        tokenCount = cloudBackupStatus.syncedTokenCount,
                        secretEntryCount = cloudBackupStatus.syncedSecretEntryCount,
                        secretTrashEntryCount = cloudBackupStatus.syncedSecretTrashEntryCount,
                    )
                }
            }
        }
